...
const outputsInfo = {
  ...
  UsersGroupBy: ["userID", "firstName", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  UsersCountAggregate: ["userID", "firstName", "_all"],
  UsersAvgAggregate: ["userID"],
  UsersSumAggregate: ["userID"],
  UsersMinAggregate: ["userID", "firstName"],
  UsersMaxAggregate: ["userID", "firstName"]
};
...
const inputsInfo = {
  UsersWhereInput: ["AND", "OR", "NOT", "userID", "firstName"],
  UsersOrderByWithRelationInput: ["userID", "firstName"],
  UsersWhereUniqueInput: ["userID", "AND", "OR", "NOT", "firstName"],
  UsersOrderByWithAggregationInput: ["userID", "firstName", "_count", "_avg", "_max", "_min", "_sum"],
  UsersScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "userID", "firstName"],
  UsersCreateInput: ["firstName"],
  UsersUpdateInput: ["firstName"],
  UsersCreateManyInput: ["userID", "firstName"],
  UsersUpdateManyMutationInput: ["firstName"],
  IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  StringFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "not"],
  UsersCountOrderByAggregateInput: ["userID", "firstName"],
  UsersAvgOrderByAggregateInput: ["userID"],
  UsersMaxOrderByAggregateInput: ["userID", "firstName"],
  UsersMinOrderByAggregateInput: ["userID", "firstName"],
  UsersSumOrderByAggregateInput: ["userID"],
